diff --git a/.env copy b/.env_remote
similarity index 100%
rename from .env copy
rename to .env_remote
diff --git a/.vscode/launch.json b/.vscode/launch.json
index 486602f..de6b8ef 100644
...
@@ -2,10 +2,10 @@
     ...
     "configurations": [
         {
-            "name": "Debug agents/s01_ollama1.py",
+            "name": "Debug agents/s01_ollama2.py",
             "type": "debugpy",
             "request": "launch",
-            "program": "${workspaceFolder}\\agents\\s01_ollama1.py",
+            "program": "${workspaceFolder}\\agents\\s01_ollama2.py",
             "console": "integratedTerminal",
             "justMyCode": true,
             "cwd": "${workspaceFolder}"
diff --git a/agents/s01_ollama1.py b/agents/s01_ollama1.py
index bda1c94..841feb0 100644
--- a/agents/s01_ollama1.py
+++ b/agents/s01_ollama1.py
...
diff --git a/agents/s01_ollama2.py b/agents/s01_ollama2.py
new file mode 100644
index 0000000..8edeada
--- /dev/null
+++ b/agents/s01_ollama2.py
@@ -0,0 +1,169 @@
+#!/usr/bin/env python3
